...
PHOTOS: dict[str, list[dict[str, Any]]] = {
    "Single": [
        {"url": "https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800", "public_id": "seed-single-1", "is_primary": True},
        {"url": "https://images.unsplash.com/photo-1595576508898-0ad5c879a061?w=800", "public_id": "seed-single-2", "is_primary": False},
        {"url": "https://images.unsplash.com/photo-1566665797739-1674de7a421a?w=800", "public_id": "seed-single-3", "is_primary": False},
    ],
    "Double": [
        {"url": "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=800", "public_id": "seed-double-1", "is_primary": True},
        {"url": "https://images.unsplash.com/photo-1590490360182-c33d57733427?w=800", "public_id": "seed-double-2", "is_primary": False},
        {"url": "https://images.unsplash.com/photo-1560185007-cde436f6a4d0?w=800", "public_id": "seed-double-3", "is_primary": False},
    ],
    "Triple": [
        {"url": "https://images.unsplash.com/photo-1584132967334-10e028bd69f7?w=800", "public_id": "seed-triple-1", "is_primary": True},
        {"url": "https://images.unsplash.com/photo-1571508601891-ca5e7a713859?w=800", "public_id": "seed-triple-2", "is_primary": False},
        {"url": "https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800", "public_id": "seed-triple-3", "is_primary": False},
    ],
    "Suite": [
        {"url": "https://images.unsplash.com/photo-1618773928121-c32242e63f39?w=800", "public_id": "seed-suite-1", "is_primary": True},
        {"url": "https://images.unsplash.com/photo-1578683010236-d716f9a3f461?w=800", "public_id": "seed-suite-2", "is_primary": False},
        {"url": "https://images.unsplash.com/photo-1609766857196-bc8eda90d9c8?w=800", "public_id": "seed-suite-3", "is_primary": False},
    ],
    "Villa": [
        {"url": "https://images.unsplash.com/photo-1613977257363-707ba9348227?w=800", "public_id": "seed-villa-1", "is_primary": True},
        {"url": "https://images.unsplash.com/photo-1615880484746-a134be9a6ecf?w=800", "public_id": "seed-villa-2", "is_primary": False},
        {"url": "https://images.unsplash.com/photo-1602343168117-bb8ffe3e2e9f?w=800", "public_id": "seed-villa-3", "is_primary": False},
    ],
    "Homestay": [
        {"url": "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800", "public_id": "seed-homestay-1", "is_primary": True},
        {"url": "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800", "public_id": "seed-homestay-2", "is_primary": False},
        {"url": "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800", "public_id": "seed-homestay-3", "is_primary": False},
    ],
    "Dormitory": [
        {"url": "https://images.unsplash.com/photo-1555854877-0b3465818bcf?w=800", "public_id": "seed-dorm-1", "is_primary": True},
        {"url": "https://images.unsplash.com/photo-1595526114035-0d45ed16cfbf?w=800", "public_id": "seed-dorm-2", "is_primary": False},
        {"url": "https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800", "public_id": "seed-dorm-3", "is_primary": False},
    ],
}
...
AMENITIES: dict[str, list[str]] = {
    ...
    "Double_premium": ["WiFi", "AC", "TV", "Parking", "Room Service", "Breakfast Included", "Hair Dryer", "Laundry"],
    "Triple": ["WiFi", "AC", "TV", "Parking", "Kitchen", "Hot Water", "Iron", "Laundry"],
    "Suite": ["WiFi", "AC", "TV", "Parking", "Minibar", "Room Service", "Breakfast Included", "Jacuzzi", "Hair Dryer", "Laundry", "CCTV", "Security Guard"],
    "Villa": ["WiFi", "AC", "TV", "Parking", "Kitchen", "Pool", "Gym", "Jacuzzi", "Minibar", "Garden View", "Room Service", "Breakfast Included", "Airport Shuttle", "EV Charging", "CCTV", "Security Guard", "Laundry", "Hair Dryer"],
    "Homestay": ["WiFi", "Kitchen", "Hot Water", "Parking", "TV", "Laundry", "Breakfast Included"],
...
HOST_ROOM_SPECS: dict[str, list[dict[str, str]]] = {
    "rajesh": [
        {"title": "Grand Single, MG Road Central", "area": "MG Road", "category": "Single"},
        {"title": "Executive Double, Indiranagar", "area": "Indiranagar", "category": "Double"},
        {"title": "Business Suite, Whitefield Tech Park", "area": "Whitefield", "category": "Suite"},
        {"title": "Premier Double with City View, Brigade Road", "area": "Brigade Road", "category": "Double"},
        {"title": "Deluxe Triple, Cunningham Road", "area": "Cunningham Road", "category": "Triple"},
        {"title": "Heritage Suite, Richmond Town", "area": "Richmond Town", "category": "Suite"},
        {"title": "Luxury Double, Sadashivanagar", "area": "Sadashivanagar", "category": "Double"},
        {"title": "Corporate Single, Dollars Colony", "area": "Dollars Colony", "category": "Single"},
        {"title": "Classic Double, Benson Town", "area": "Benson Town", "category": "Double"},
        {"title": "Panoramic Suite, Koramangala", "area": "Koramangala", "category": "Suite"},
        {"title": "Garden Double, Hebbal", "area": "Hebbal", "category": "Double"},
        {"title": "Premium Single, Malleshwaram", "area": "Malleshwaram", "category": "Single"},
    ],
    "sunshine": [
        {"title": "Cozy Double, Jayanagar", "area": "Jayanagar", "category": "Double"},
        {"title": "Family Triple, JP Nagar", "area": "JP Nagar", "category": "Triple"},
        {"title": "Studio Single, Bannerghatta Road", "area": "Bannerghatta", "category": "Single"},
        {"title": "Peaceful Double, Bellandur", "area": "Bellandur", "category": "Double"},
        {"title": "Modern Single, HSR Layout", "area": "HSR Layout", "category": "Single"},
        {"title": "Comfortable Double, Rajajinagar", "area": "Rajajinagar", "category": "Double"},
        {"title": "Economy Triple, Sarjapur", "area": "Sarjapur", "category": "Triple"},
        {"title": "Budget Double, Electronic City", "area": "Electronic City", "category": "Double"},
        {"title": "Heritage Homestay, Jayanagar", "area": "Jayanagar", "category": "Homestay"},
        {"title": "Family Homestay with Garden, HSR Layout", "area": "HSR Layout", "category": "Homestay"},
    ],
    "prestige": [
        {"title": "Presidential Suite, Koramangala", "area": "Koramangala", "category": "Suite"},
        {"title": "Penthouse Suite, Indiranagar", "area": "Indiranagar", "category": "Suite"},
        {"title": "Ultra Luxury Villa, UB City", "area": "UB City", "category": "Villa"},
        {"title": "Royal Suite, Sadashivanagar", "area": "Sadashivanagar", "category": "Suite"},
        {"title": "Ambassador Suite, MG Road", "area": "MG Road", "category": "Suite"},
        {"title": "Heritage Villa, Richmond Town", "area": "Richmond Town", "category": "Villa"},
        {"title": "Sky Suite, Whitefield", "area": "Whitefield", "category": "Suite"},
        {"title": "Grand Villa, Hebbal", "area": "Hebbal", "category": "Villa"},
    ],
    "budgethost": [
        {"title": "Economy Single, Electronic City", "area": "Electronic City", "category": "Single"},
        {"title": "Budget Double, Marathahalli", "area": "Marathahalli", "category": "Double"},
        {"title": "Affordable Single, Sarjapur", "area": "Sarjapur", "category": "Single"},
        {"title": "Value Double, Bellandur", "area": "Bellandur", "category": "Double"},
        {"title": "Starter Single, Yelahanka", "area": "Yelahanka", "category": "Single"},
        {"title": "Basic Double, Hebbal", "area": "Hebbal", "category": "Double"},
        {"title": "No-frills Single, HSR Layout", "area": "HSR Layout", "category": "Single"},
        {"title": "Simple Double, JP Nagar", "area": "JP Nagar", "category": "Double"},
        {"title": "Backpacker Dorm Bed, Electronic City", "area": "Electronic City", "category": "Dormitory"},
        {"title": "Shared Dorm, Marathahalli", "area": "Marathahalli", "category": "Dormitory"},
        {"title": "Budget Dorm Bed, Yelahanka", "area": "Yelahanka", "category": "Dormitory"},
    ],
    "villahost": [
        {"title": "Nandi Hills Villa with Pool", "area": "Nandi Hills", "city": "Nandi Hills", "category": "Villa"},
        {"title": "Sunrise Suite, Skandagiri", "area": "Skandagiri", "city": "Nandi Hills", "category": "Suite"},
        {"title": "Hilltop Homestay, Nandi Hills", "area": "Nandi Hills", "city": "Nandi Hills", "category": "Homestay"},
        {"title": "Misty View Double, Nandi Hills", "area": "Nandi Hills", "city": "Nandi Hills", "category": "Double"},
        {"title": "Sadashivanagar Heritage Villa", "area": "Sadashivanagar", "category": "Villa"},
        {"title": "Luxury Pool Villa, Dollars Colony", "area": "Dollars Colony", "category": "Villa"},
        {"title": "Garden Villa with Jacuzzi, Malleshwaram", "area": "Malleshwaram", "category": "Villa"},
        {"title": "Executive Villa Suite, Cunningham Road", "area": "Cunningham Road", "category": "Villa"},
        {"title": "Forest View Villa, Benson Town", "area": "Benson Town", "category": "Villa"},
    ],
    "goahost": [
        {"title": "Beachside Homestay, Calangute", "area": "Calangute", "city": "North Goa", "category": "Homestay"},
        {"title": "Portuguese Villa Homestay, Anjuna", "area": "Anjuna", "city": "North Goa", "category": "Homestay"},
        {"title": "Cozy Double near Baga Beach", "area": "Baga", "city": "North Goa", "category": "Double"},
        {"title": "Sea View Suite, Vagator", "area": "Vagator", "city": "North Goa", "category": "Suite"},
        {"title": "Pool Villa, Candolim", "area": "Candolim", "city": "North Goa", "category": "Villa"},
        {"title": "Backpacker Dorm, Calangute", "area": "Calangute", "city": "North Goa", "category": "Dormitory"},
    ],
    "mumbaihost": [
        {"title": "Colaba Heritage Homestay", "area": "Colaba", "city": "Mumbai", "category": "Homestay"},
        {"title": "Bandra West Studio Single", "area": "Bandra West", "city": "Mumbai", "category": "Single"},
        {"title": "Andheri Business Double", "area": "Andheri West", "city": "Mumbai", "category": "Double"},
        {"title": "Powai Lake View Suite", "area": "Powai", "city": "Mumbai", "category": "Suite"},
        {"title": "Juhu Beach Backpacker Dorm", "area": "Juhu", "city": "Mumbai", "category": "Dormitory"},
        {"title": "Marine Drive Dorm Bed", "area": "Colaba", "city": "Mumbai", "category": "Dormitory"},
    ],
    "coorghost": [
        {"title": "Coffee Estate Homestay, Madikeri", "area": "Madikeri", "city": "Coorg", "category": "Homestay"},
        {"title": "Misty Hills Homestay, Kushalnagar", "area": "Kushalnagar", "city": "Coorg", "category": "Homestay"},
        {"title": "Plantation Villa, Virajpet", "area": "Virajpet", "city": "Coorg", "category": "Villa"},
        {"title": "Forest View Cottage, Gonikoppal", "area": "Gonikoppal", "city": "Coorg", "category": "Homestay"},
        {"title": "Hilltop Homestay, Madikeri", "area": "Madikeri", "city": "Coorg", "category": "Homestay"},
    ],
}
...
NOTIFICATION_TEMPLATES = [
    ...
    ("booking_reminder", "Check-in reminder", "Check-in reminder: 3 days to go for your stay at {room}!"),
    ("offer_alert", "Special offer", "Use code SUMMER20 for 20% off your next booking."),
    ("review_request", "Leave a review", "How was your stay at {room}? Leave a review."),
    ("waitlist_notify", "Waitlist update", "Room {room} is now available for your dates!"),
    ("referral_credit", "Referral reward", "You earned 200 referral credits!"),
    ("cancellation_alert", "Booking cancelled", "Your booking at {room} was cancelled successfully."),
]
...
def _build_attractions() -> list[dict[str, Any]]:
    by_city: dict[str, list[tuple[str, str, float, str, str]]] = {
        "Bangalore": [
            ("Food", "MTR Restaurant, Lalbagh Road", 0.5, "Famous for authentic South Indian breakfast", "6:30 AM - 9:00 PM"),
            ("Food", "Koshy's, St Marks Road", 1.2, "Iconic Bangalore cafe since 1940", "9:00 AM - 11:00 PM"),
            ("Food", "Truffles, Koramangala", 2.1, "Best burgers in Bangalore", "11:00 AM - 11:30 PM"),
            ("Food", "Vidyarthi Bhavan, Gandhi Bazaar", 3.4, "Legendary masala dosa since 1943", "6:30 AM - 11:30 AM"),
            ("Food", "Corner House Ice Cream", 0.8, "Bangalore most loved ice cream", "11:00 AM - 11:00 PM"),
            ("Food", "Empire Restaurant, Church Street", 1.5, "Famous for biryani and kebabs", "12:00 PM - 12:00 AM"),
            ("Food", "Brahmin's Coffee Bar, Basavanagudi", 2.8, "Classic filter coffee and idli-vada", "7:00 AM - 11:30 AM"),
            ("Food", "The Only Place, Museum Road", 1.1, "Oldest continental restaurant in Bangalore", "12:00 PM - 11:00 PM"),
            ("Temples", "ISKCON Temple, Rajajinagar", 4.2, "Magnificent Krishna temple", "4:15 AM - 8:30 PM"),
            ("Temples", "Bull Temple, Basavanagudi", 3.1, "400-year-old Nandi temple", "6:00 AM - 8:30 PM"),
            ("Temples", "Dodda Ganesha Temple", 3.2, "Huge Ganesha idol", "6:00 AM - 8:00 PM"),
            ("Temples", "Gavi Gangadhareshwara", 3.8, "Cave temple, unique light phenomenon", "6:00 AM - 8:00 PM"),
            ("Parks", "Cubbon Park, CBD", 1.8, "300-acre green lung of Bangalore", "6:00 AM - 6:00 PM"),
            ("Parks", "Lalbagh Botanical Garden", 2.5, "Oldest botanical garden 250+ acres", "6:00 AM - 7:00 PM"),
            ("Parks", "Ulsoor Lake", 2.2, "Serene lake for morning walks", "5:00 AM - 8:00 PM"),
            ("Parks", "Bannerghatta National Park", 22.0, "Wildlife safari with tigers and lions", "9:30 AM - 5:00 PM"),
            ("Parks", "Sankey Tank, Malleshwaram", 3.5, "Peaceful lake garden", "5:00 AM - 8:00 PM"),
            ("Shopping", "UB City Mall", 1.5, "Luxury brands and fine dining", "10:00 AM - 11:00 PM"),
            ("Shopping", "Phoenix MarketCity, Whitefield", 12.0, "Largest mall in Bangalore", "10:00 AM - 11:00 PM"),
            ("Shopping", "Commercial Street", 2.1, "Best street shopping in Bangalore", "10:00 AM - 9:00 PM"),
            ("Shopping", "Brigade Road", 1.8, "Popular shopping and cafes", "10:00 AM - 10:00 PM"),
            ("Shopping", "Chickpet", 4.5, "Wholesale fabrics and jewellery", "9:00 AM - 8:00 PM"),
            ("Transport", "Kempegowda Airport", 34.0, "International airport serving Bangalore", "24 hours"),
            ("Transport", "MG Road Metro", 0.3, "Namma Metro purple line station", "5:00 AM - 11:00 PM"),
            ("Transport", "KSR Railway Station", 5.2, "Main railway terminal for Bangalore", "24 hours"),
            ("Transport", "Majestic Bus Stand", 5.5, "Central interstate bus terminal", "24 hours"),
            ("Hospital", "Manipal Hospital", 3.2, "Multi-speciality hospital", "24 hours"),
            ("Hospital", "Apollo Hospital", 8.5, "Leading private hospital chain", "24 hours"),
            ("Hospital", "Fortis Hospital", 2.1, "Emergency and speciality care", "24 hours"),
        ],
        "Mumbai": [
            ("Landmarks", "Gateway of India", 1.2, "Iconic arch monument on the waterfront", "24 hours"),
            ("Landmarks", "Marine Drive", 2.5, "Scenic 3 km promenade along the Arabian Sea", "24 hours"),
            ("Food", "Leopold Cafe, Colaba", 0.8, "Historic cafe famous since 1871", "7:30 AM - 12:00 AM"),
            ("Food", "Bademiya, Colaba", 1.0, "Legendary late-night kebabs and rolls", "7:00 PM - 4:00 AM"),
            ("Food", "Britannia & Co., Fort", 3.5, "Parsi berry pulao and dhansak since 1923", "11:00 AM - 4:00 PM"),
            ("Shopping", "Colaba Causeway", 1.5, "Street shopping for clothes and souvenirs", "10:00 AM - 9:00 PM"),
            ("Shopping", "Crawford Market", 4.0, "Historic wholesale market for spices and produce", "10:00 AM - 8:00 PM"),
            ("Parks", "Hanging Gardens", 5.0, "Terraced gardens with city skyline views", "5:00 AM - 9:00 PM"),
            ("Temples", "Siddhivinayak Temple", 12.0, "Famous Ganesha temple in Prabhadevi", "5:30 AM - 10:00 PM"),
            ("Transport", "Chhatrapati Shivaji Terminus", 4.5, "UNESCO World Heritage railway station", "24 hours"),
            ("Transport", "Mumbai Airport", 8.0, "Chhatrapati Shivaji International Airport", "24 hours"),
            ("Hospital", "Tata Memorial Hospital", 6.0, "Leading cancer care centre", "24 hours"),
        ],
        "North Goa": [
            ("Beaches", "Calangute Beach", 0.5, "Queen of Beaches — popular water sports hub", "24 hours"),
            ("Beaches", "Baga Beach", 1.2, "Lively beach with shacks and nightlife", "24 hours"),
            ("Beaches", "Anjuna Beach", 2.0, "Famous flea market and cliff views", "24 hours"),
            ("Beaches", "Vagator Beach", 2.5, "Red cliffs and Chapora Fort views", "24 hours"),
            ("Food", "Britto's, Baga", 1.5, "Beach shack serving Goan seafood", "11:00 AM - 11:00 PM"),
            ("Food", "Fisherman's Wharf, Candolim", 3.0, "Goan and coastal cuisine by the water", "12:00 PM - 11:00 PM"),
            ("Landmarks", "Chapora Fort", 3.5, "Historic fort with panoramic sea views", "9:30 AM - 5:30 PM"),
            ("Landmarks", "Basilica of Bom Jesus, Old Goa", 18.0, "UNESCO World Heritage church", "9:00 AM - 6:30 PM"),
            ("Shopping", "Anjuna Flea Market", 2.5, "Wednesday hippie market for crafts and clothes", "Wed 9:00 AM - 6:00 PM"),
            ("Parks", "Salim Ali Bird Sanctuary", 8.0, "Mangrove bird sanctuary on Chorao Island", "6:00 AM - 6:00 PM"),
            ("Transport", "Goa Airport (Dabolim)", 40.0, "Nearest international airport", "24 hours"),
            ("Hospital", "Goa Medical College", 15.0, "Government multi-speciality hospital", "24 hours"),
        ],
        "Coorg": [
            ("Nature", "Abbey Falls", 8.0, "Picturesque waterfall amid coffee plantations", "9:00 AM - 5:00 PM"),
            ("Nature", "Raja's Seat", 2.0, "Sunset viewpoint with misty valley panoramas", "5:30 AM - 8:00 PM"),
            ("Nature", "Dubare Elephant Camp", 15.0, "Elephant interaction and river rafting", "9:00 AM - 5:00 PM"),
            ("Nature", "Talacauvery", 45.0, "Origin of the Cauvery river at Brahmagiri hills", "6:00 AM - 6:00 PM"),
            ("Food", "Coorg Cuisine, Madikeri", 1.5, "Authentic pandi curry and kadumbuttu", "11:00 AM - 10:00 PM"),
            ("Food", "Taste of Coorg, Kushalnagar", 5.0, "Traditional Kodava meals", "12:00 PM - 9:00 PM"),
            ("Temples", "Omkareshwara Temple", 1.0, "Historic Shiva temple in Madikeri town", "6:30 AM - 8:00 PM"),
            ("Temples", "Golden Temple (Namdroling)", 6.0, "Tibetan Buddhist monastery in Bylakuppe", "7:00 AM - 6:00 PM"),
            ("Shopping", "Madikeri Market", 1.2, "Local spices, coffee, and honey", "8:00 AM - 8:00 PM"),
            ("Parks", "Nagarhole National Park", 35.0, "Tiger reserve and wildlife safari", "6:00 AM - 6:00 PM"),
            ("Hospital", "Victoria Hospital, Madikeri", 2.0, "District government hospital", "24 hours"),
        ],
        "Nandi Hills": [
            ("Nature", "Nandi Hills Summit", 1.0, "Sunrise viewpoint at 1,478 m elevation", "6:00 AM - 6:00 PM"),
            ("Nature", "Tipu's Drop", 1.5, "Historic cliff with valley views", "6:00 AM - 6:00 PM"),
            ("Nature", "Amrita Sarovar Lake", 0.8, "Serene perennial lake at the hilltop", "6:00 AM - 6:00 PM"),
            ("Temples", "Bhoga Nandeeshwara Temple", 3.0, "Ancient Shiva temple at the foothills", "6:00 AM - 8:00 PM"),
            ("Nature", "Skandagiri Trek", 5.0, "Popular night trek with sunrise views", "Guided treks"),
            ("Food", "Mayura Pine Top, Nandi Hills", 0.5, "KSTDC restaurant with hill views", "8:00 AM - 6:00 PM"),
            ("Parks", "Nandi Hills Forest Trail", 2.0, "Scenic walking trail through eucalyptus groves", "6:00 AM - 6:00 PM"),
            ("Hospital", "Nandi Hills PHC", 8.0, "Primary health centre at foothills", "9:00 AM - 5:00 PM"),
        ],
    }
...
def _build_bookings(
    ...
    summer_guests = ["nandeesh@stayease.com", "arjun@stayease.com", "meera@stayease.com"]
    pending_guests = ["priya@stayease.com", "rahul@stayease.com", "nandeesh@stayease.com"]
    ...
    for i in range(10):
        ...
        ci, co = schedule.allocate(
            room["_id"], TODAY + timedelta(days=1), TODAY + timedelta(days=14), nights, rng
        )
        add_booking(
            room,
...
def _build_notifications(users: list[dict[str, Any]], rooms: list[dict[str, Any]], rng: random.Random) -> list[dict[str, Any]]:
    notifications: list[dict[str, Any]] = []
    channels = ["email", "whatsapp", "in-app"]
    sample_room = rooms[0]["title"] if rooms else "your room"
    for user in users:
        for i in range(10):
            ntype, title, body_tpl = NOTIFICATION_TEMPLATES[i % len(NOTIFICATION_TEMPLATES)]
...
async def seed() -> None:
    ...
    try:
        ...
        review_docs = _build_reviews(completed_bookings, rooms_by_id, host_key_by_id, rng)
